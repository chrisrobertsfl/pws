...
data class LogFileEventuallyContains(override val name: String = generateName(), var duration: Duration = 10.seconds, var initialDelay: Duration = 0.seconds, var searchedText: String = emptyString(), var ignoreCase: Boolean = true) : Action {

    private val logger by lazy { LoggerFactory.getLogger(LogFileEventuallyContains::class.java) }
    private val timeFrame by lazy { TimeFrame(duration = duration, initialDelay = initialDelay) }
